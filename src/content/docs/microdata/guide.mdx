...
We trialed the following experiments in classrooms and found them to be an engaging way to teach physics and data science to secondary school students:
 - [Finding the magnetometer](/microdata/magnetometer_location)
 - [Magnetism and distance](/microdata/magnetism_and_distance)
 - [Light, colour and filtering](/microdata/light)
 - [Micro:bit drop](/microdata/microbit-drop)
