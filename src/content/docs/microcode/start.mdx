...
Programming takes place when the micro:bit is connected to a [display shield](/getting-started/display-shields/).
Your program is saved automatically after each edit and runs on the micro:bit, with or without the display shield.


## Getting Started

- [Open MicroCode in MakeCode](https://makecode.microbit.org/beta/#pub:37622-75285-88073-70878).
